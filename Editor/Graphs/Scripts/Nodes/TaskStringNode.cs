...
namespace HelloDev.QuestSystem.QuestGraph.Editor.Nodes
{
    ...
    /// </remarks>
    [Serializable]
    public class TaskStringNode : TaskBaseNode
    {
        #region Option Names
        ...
        public override Task_SO TaskAsset
        {
            get
            {
                if (!UseTaskAsset)
                    return null;
                return GraphTraversalUtility.ResolveDataPort<TaskString_SO>(this, PORT_TASK_ASSET, null);
            }
        }
        ...
        {
            return InlineData.CreateTaskAsset<TaskString_SO>();
        }
