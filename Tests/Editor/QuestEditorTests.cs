...
//             
//             // Create a task group with the test tasks
//             var taskGroup = ScriptableObject.CreateInstance<TaskGroup>();
//             taskGroup.name = "Test Task Group";
//             taskGroup.GroupType = TaskGroupType.Sequential;
//             taskGroup.Tasks = new List<Task_SO> { _taskData1, _taskData1 };
//             
//             // Initialize task groups list and add our test group
//             var taskGroups = new List<TaskGroup> { taskGroup };
//             SetPrivateField(_questData, "taskGroups", taskGroups);
//             
...
//             if (_questData != null) 
//             {
//                 // Clean up task groups first
//                 var taskGroups = _questData.TaskGroups;
//                 if (taskGroups != null)
//                 {
...
//                     }
//                 }
//                 UnityEngine.Object.DestroyImmediate(_questData);
//             }
...
//         {
//             Assert.AreEqual(2, _questData.AllTasks.Count);
//         }
//
//         [Test]
